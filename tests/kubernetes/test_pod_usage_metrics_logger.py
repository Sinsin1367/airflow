...
class TestPodUsageMetricsLogger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pod_launcher._client.api_client.call_api.side_effect = self.api_response_side_effect
    ...
    def test_log_pod_usage_metrics_call_counts(self):
        ...
        self.assertEqual(self.pod_launcher._client.api_client.call_api.call_count, 2)
    ...
    def test_log_pod_usage_metrics_invalid_usage_units(self):
        self.pod_launcher._client.api_client.call_api.side_effect = self.invalid_api_response_side_effect
        self.pod_usage_metrics_logger.log_pod_usage_metrics()
    ...
    def test__convert_str_memory_usage_to_int_kilobyte(self):
